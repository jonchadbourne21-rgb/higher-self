...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapawesomeCapacitorAppleSignIn", path: "../../../node_modules/.pnpm/@capawesome+capacitor-apple-sign-in@0.1.4_@capacitor+core@8.4.2/node_modules/@capawesome/capacitor-apple-sign-in"),
