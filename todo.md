...
## Dead Code Cleanup (Jul 19)
- [x] Delete server/reward-wheel.test.ts (dead test file for deleted wheel system, 27 tests)
- [x] Delete server/db/streakTracking.ts (only imported by dead reward-wheel test)
- [x] Trim server/db/rewards.ts from 15 exports to 1 (only addRewardPoints still used)
- [x] Delete client/src/pages/ComponentShowcase.tsx (dev-only gallery, no route)
- [x] Delete client/src/pages/Voice.tsx (replaced by unified Mirror page, no route)
- [x] Delete client/src/components/DashboardLayout.tsx (template component, never used)
- [x] Delete client/src/components/DashboardLayoutSkeleton.tsx (only used by deleted DashboardLayout)
