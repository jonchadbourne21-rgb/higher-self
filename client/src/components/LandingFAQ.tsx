...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: (
      <div className="space-y-2">
        <p>
          <strong>No.</strong> Mirrored is <strong>not</strong> a licensed therapist, psychologist, medical doctor, or crisis counselor. It does not provide medical advice, diagnosis, or treatment. It is not a substitute for professional mental health care.
        </p>
  ...
  },
  {
    ...
    answer:
      "Yes! Mirrored is fully optimized for mobile devices. You can access all features—chat, journaling, habit tracking, and insights—from your phone or tablet.",
  },
];
      ...
      <div className="mt-10 pt-8 border-t border-border">
        <div className="rounded-2xl p-4" style={{ background: "oklch(0.95 0.04 15 / 0.5)", border: "1px solid oklch(0.85 0.06 15 / 0.4)" }}>
          <p className="text-xs text-muted-foreground leading-relaxed">
            <strong>Important:</strong> Mirrored is an AI-powered self-reflection tool. It is not a licensed therapist, medical doctor, or crisis counselor. If you need professional mental health support, please consult a licensed healthcare provider. In crisis? Call 988 or 911.
          </p>
        </div>
      </div>
    </div>
